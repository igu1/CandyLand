...
//
//import me.ez.candyland.Common.Block.CandyTpBlock;
...
//
//    public CandyTeleporter(BlockPos pos, boolean insideDim) {
//        thisPos = pos;
...
//                if (destWorld.getBlockState(checkPos).getBlock() instanceof CandyTpBlock) {
//                    doSetBlock = false;
//                    break;
//                }
//            }
//            if (doSetBlock) {
//                destWorld.setBlockAndUpdate(destinationPos, Blockinit.CANDY_TP_BLOCK.get().defaultBlockState());
//                destWorld.setBlock(destinationPos, Blockinit.CANDY_TP_BLOCK.get().defaultBlockState(), 1);
//            }
//        }
//        return entity;
//    }
