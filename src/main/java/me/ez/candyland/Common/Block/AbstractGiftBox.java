...
public class AbstractGiftBox extends Block {

    public AbstractGiftBox(Properties properties) {
        super(properties);
    }
    ...
    public void onRemove(BlockState state, Level level, BlockPos pos, BlockState state1, boolean p_60519_) {
        if (!level.isClientSide) {
            ...
            List<ItemStack> gift_drops = List.of(
                    ...
                    new ItemStack(Iteminit.LOLLIPOP.get(), rand.nextInt(8)),
                    new ItemStack(Iteminit.LOLLIPOP.get(), rand.nextInt(5)),
                    ...
                    new ItemStack(Items.IRON_INGOT, rand.nextInt(4)),
                    new ItemStack(Items.IRON_INGOT, rand.nextInt(3)),
                    new ItemStack(Items.IRON_INGOT, rand.nextInt(6)),
                    new ItemStack(Items.IRON_INGOT, rand.nextInt(2)),
                    new ItemStack(Items.IRON_INGOT, rand.nextInt(1)),
                    new ItemStack(Items.COAL, rand.nextInt(10)),
                    new ItemStack(Items.COAL, rand.nextInt(4)),
                    new ItemStack(Items.COAL, rand.nextInt(5)),
                    new ItemStack(Items.COAL, rand.nextInt(15)),

                    new ItemStack(Iteminit.CANDY_GUNPOWDER.get(), rand.nextInt(4)),
                    new ItemStack(Iteminit.CANDY_GUNPOWDER.get(), rand.nextInt(4)),
                    new ItemStack(Iteminit.CANDY_GUNPOWDER.get(), rand.nextInt(4))
            );
            for (int x = 0; x < rand.nextInt(4, 5); x++) {
